                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="form-control input-sm" name="product_id" value="@if(isset($data['product_id'])){{$data['product_id']}}@endif">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="form-control input-sm" name="rating_name" value="@if(isset($data['rating_name'])){{$data['rating_name']}}@endif">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="form-control input-sm" name="rating_email" value="@if(isset($data['rating_email'])){{$data['rating_email']}}@endif">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="form-control input-sm" name="rating_detail" value="@if(isset($data['rating_detail'])){{$data['rating_detail']}}@endif">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="form-control input-sm" name="rating_star" value="@if(isset($data['rating_star'])){{$data['rating_star']}}@endif">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="form-control input-sm" name="rating_ip" value="@if(isset($data['rating_ip'])){{$data['rating_ip']}}@endif">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select name="rating_status" >
                                                                        <option value="0" @if($data['rating_status'] == 0)  selected="selected" @endif>Ẩn</option>
                                                                        <option value="1" @if($data['rating_status'] == 1)  selected="selected" @endif>Hiện</option>
