        ...
        <div class="main-content-inner">
            <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">@if($id==0)Thêm mới @else Sửa @endif Từ khóa</li>
                </ul>
            </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="form-control input-sm" name="tag_title" value="@if(isset($data['tag_title'])){{$data['tag_title']}}@endif">
                                                                </div>
                                                            </div>
                                                        </div>
