                            ...
                            <form id="frmSearch" method="GET" action="" class="frmSearch" name="frmSearch">
                                <div class="panel-body panel-search">
                                    <div class="form-group col-lg-2">
                                        ...
                                        <div>
                                            <input type="text" class="form-control input-sm" name="rating_title" <?php if(isset($search['rating_name']) && $search['rating_name'] !=''): ?>value="<?php echo e($search['rating_name']); ?>"<?php endif; ?>>
                                        </div>
                                    </div>

                                </div>
                                <div class="panel-footer text-right">
                                    <a class="btn btn-default btn-sm" class="reset" href="<?php echo e(route('admin.rating')); ?>"><i class="fa fa-recycle"></i>Bỏ lọc</a>
                                    <a class="btn btn-danger btn-sm" href="<?php echo e(FuncLib::getBaseUrl()); ?>admin/rating/edit"><i class="ace-icon fa fa-plus-circle"></i>Thêm mới</a>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <label class="pos-rel">
                                                    <input class="ace checkItem" name="checkItem[]" value="<?php echo e($item['rating_id']); ?>" type="checkbox">
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>
                                            <td><a target="_blank" title="<?php echo e($item->rating_name); ?>" href=""><?php echo e($item['rating_name']); ?></a></td>
                                            <td><a target="_blank" title="<?php echo e($item->rating_email); ?>" href=""><?php echo e($item['rating_email']); ?></a></td>
                                            <td><a target="_blank" title="<?php echo e($item->rating_detail); ?>" href=""><?php echo e($item['rating_detail']); ?></a></td>
                                            <td><a target="_blank" title="<?php echo e($item->rating_star); ?>" href=""><?php echo e($item['rating_star']); ?></a></td>
                                            <td><a target="_blank" title="<?php echo e($item->rating_ip); ?>" href=""><?php echo e($item['rating_ip']); ?></a></td>
                                            <td>
                                                <a target="_blank" title="<?php echo e($item->rating_status); ?>" href="">
                                                    <?php echo e(($item['rating_status']==0) ? 'Ẩn' : 'Hiện'); ?>

                                                </a>
                                            </td>
                                            <td>
                                                <a href="<?php echo e(FuncLib::getBaseUrl()); ?>admin/rating/edit/<?php echo e($item['rating_id']); ?>" title="Cập nhật">
...
<?php echo $__env->make('Admin::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\project.vn\midas.com.vn\app\Modules/Admin/Views/rating/list.blade.php ENDPATH**/ ?>