        ...
        <div id="pd-page">
            <div class="container">
                <div class="title-project txt-center">
                    <?php if(isset($objTags) && !empty($objTags)): ?>
                        <p class="count">
                            Từ khóa: <?php echo e($objTags->tag_title); ?>
                        ...
                        <div class="project-done">
                            <?php if(isset($data) && !empty($data)): ?>
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(isset($item->statics_tag) && $item->statics_tag != ''): ?>
...
<?php echo $__env->make('Statics::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\project.vn\midas.com.vn\app\Modules/Statics/Views/content/pageTag.blade.php ENDPATH**/ ?>