            ...
            <?php $__currentLoopData = $dataBannerHeader; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="carousel-cell">
                    <img class="carousel-cell-image"
                         data-flickity-lazyload="<?php echo e(ThumbImg::thumbBaseNormal(CGlobal::FOLDER_BANNER, $item['banner_id'],$item['banner_image'], 1600,0, '', true, true, false)); ?>" />
                </div>
                    ...
                    <div class="carousel-cell">
                        <a href="<?php echo e(FuncLib::buildLinkProduct($item->product_id, $item->product_title)); ?>">
                            <img class="carousel-cell-image" alt="walrus"
                                 data-flickity-lazyload-src="<?php echo e(ThumbImg::thumbBaseNormal(CGlobal::FOLDER_PRODUCT, $item->product_id,$item->product_image, 0,0, '', true, true, false)); ?>"
                                 data-flickity-lazyload-srcset="
                                        <?php echo e(ThumbImg::thumbBaseNormal(CGlobal::FOLDER_PRODUCT, $item->product_id,$item->product_image, 0,0, '', true, true, false)); ?> 520w,
                                        <?php echo e(ThumbImg::thumbBaseNormal(CGlobal::FOLDER_PRODUCT, $item->product_id,$item->product_image, 0,0, '', true, true, false)); ?> 360w"
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="about-me">
                    <h5><?php echo e($item->statics_title); ?></h5>
                    <p><?php echo strip_tags($item->statics_content); ?></p>
