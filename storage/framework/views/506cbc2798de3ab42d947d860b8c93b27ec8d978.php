                                            ...
                                            <div class="tab-pane panelDetail active" id="tabNoiDung" role="tabpanel">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="form-control input-sm" name="product_title" value="<?php if(isset($data['product_title'])): ?><?php echo e($data['product_title']); ?><?php endif; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    ...
                                                                    <input name="image_primary" type="hidden" id="image_primary" value="<?php if(isset($data['product_image'])): ?><?php echo e(trim($data['product_image'])); ?><?php endif; ?>">
                                                                </div>
                                                                <!--Hien Thi Anh-->
                                                                        ...
                                                                        <?php $__currentLoopData = $news_image_other; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <li id="sys_div_img_other_<?php echo e($k); ?>">
                                                                                <div class="div_img_upload">
                                                                                    ...
                                                                                    <br/>
                                                                                    <a href="javascript:void(0);" id="sys_delete_img_other_<?php echo e($k); ?>" onclick="UploadAdmin.removeImage('<?php echo e($k); ?>', '<?php echo e($data['product_id']); ?>', '<?php echo e($v['img_other']); ?>', '6');">Xóa ảnh</a>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <textarea class="form-control input-sm" name="product_intro"><?php if(isset($data['product_intro'])): ?><?php echo e(stripslashes($data['product_intro'])); ?><?php endif; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <textarea class="form-control input-sm" name="product_content"><?php if(isset($data['product_content'])): ?><?php echo e(stripslashes($data['product_content'])); ?><?php endif; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <textarea class="form-control input-sm" name="product_price"><?php if(isset($data['product_price'])): ?><?php echo e(stripslashes($data['product_price'])); ?><?php endif; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <textarea class="form-control input-sm" name="product_size"><?php if(isset($data['product_size'])): ?><?php echo e(stripslashes($data['product_size'])); ?><?php endif; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <textarea class="form-control input-sm" name="product_color"><?php if(isset($data['product_color'])): ?><?php echo e(stripslashes($data['product_color'])); ?><?php endif; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="form-control input-sm" name="product_order_no" value="<?php if(isset($data['product_order_no'])): ?><?php echo e($data['product_order_no']); ?><?php endif; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <?php if(isset($arrTag)): ?>
                                                                <?php $__currentLoopData = $arrTag; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <label>
                                                                        <input type="checkbox" <?php if(in_array($item->tag_id, $product_tag_key)): ?> checked <?php endif; ?> name="product_tag[<?php echo e($item->tag_id); ?>]" value="<?php echo e($item->tag_title); ?>">
...
<?php echo $__env->make('Admin::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\project.vn\midas.com.vn\app\Modules/Admin/Views/product/add.blade.php ENDPATH**/ ?>