                            ...
                            <form id="frmSearch" method="GET" action="" class="frmSearch" name="frmSearch">
                                <div class="panel-body panel-search">
                                    <div class="form-group col-sm-2">
                                        ...
                                        <div>
                                            <input  type="text" class="form-control input-sm" name="orders_title" <?php if(isset($search['orders_title']) && $search['orders_title'] !=''): ?>value="<?php echo e($search['orders_title']); ?>"<?php endif; ?>>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-footer text-right">
                                    <a class="btn btn-default btn-sm" class="reset" href="<?php echo e(route('admin.orders')); ?>"><i class="fa fa-recycle"></i>Bỏ lọc</a>
                            ...
                            <form id="formListItem" method="POST" action="<?php echo e(FuncLib::getBaseUrl()); ?>admin/product/delete" class="formListItem" name="txtForm">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($item['orders_code']); ?></td>
                                            <td>
                                                <label class="pos-rel">
                                                    <input class="ace checkItem" name="checkItem[]" value="<?php echo e($item['orders_id']); ?>" type="checkbox">
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>
                                            ...
                                            <td><?php echo e($item['orders_status']); ?></td>
                                            <td><?php echo e(FuncLib::numberFormat($item['orders_price'])); ?></td>
                                            <td><?php echo e(date('d/m/Y', $item['orders_created'])); ?></td>
                                            <td>
                                                <a href="<?php echo e(FuncLib::getBaseUrl()); ?>admin/orders/edit/<?php echo e($item['orders_id']); ?>" title="Cập nhật">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\project.vn\midas.com.vn\app\Modules/Admin/Views/orders/list.blade.php ENDPATH**/ ?>